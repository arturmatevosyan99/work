...
#include "../Meta/AbstractScheme.hpp"
...
namespace Cadabra { namespace Queen { namespace Core { namespace Model {
	...
	{
		QObject::connect(&_role_list, &Meta::AbstractPropertyList::cleared, this, &SortFilterProxyModel::onRoleListCleared);
		QObject::connect(&_role_list, &Meta::AbstractPropertyList::expanded, this, &SortFilterProxyModel::onRoleListExpanded);
		QObject::connect(&_role_list, &Meta::AbstractPropertyList::updated, this, &SortFilterProxyModel::onRoleListUpdated);
	}
	...
	void SortFilterProxyModel::validate(Meta::DynamicRole* role)
	{
		if (role) {
	...
	QQmlListProperty<Meta::DynamicRole> SortFilterProxyModel::getRoleList()
	{
		return _role_list;
	}
	...
	void SortFilterProxyModel::addRole(Meta::DynamicRole* role)
	{
		onRoleListExpanded();
	}
	...
	void SortFilterProxyModel::onRoleListCleared()
	{
		invalidate();
	}

	void SortFilterProxyModel::onRoleListExpanded()
	{
