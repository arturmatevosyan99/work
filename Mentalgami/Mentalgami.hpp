#ifndef Cadabra_Queen_Mentalgami_Mentalgami_hpp
#define Cadabra_Queen_Mentalgami_Mentalgami_hpp
...
namespace Cadabra { namespace Queen { namespace Mentalgami { Q_NAMESPACE
...
Q_DECLARE_OPERATORS_FOR_FLAGS(Cadabra::Queen::Mentalgami::TrackRenderLayouts)
Q_DECLARE_METATYPE(Cadabra::Queen::Mentalgami::TrackRenderLayouts)
