#ifndef Cadabra_Queen_Mentalgami_Meta_RiddleInformation_hpp
#define Cadabra_Queen_Mentalgami_Meta_RiddleInformation_hpp
...
Q_DECLARE_OPERATORS_FOR_FLAGS(Cadabra::Queen::Mentalgami::Meta::RiddleInformation::Specifications)
