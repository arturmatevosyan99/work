#ifndef Cadabra_Queen_Mentalgami_Model_AbstractRiddle_hpp
#define Cadabra_Queen_Mentalgami_Model_AbstractRiddle_hpp
...
namespace Cadabra { namespace Queen { namespace Mentalgami { namespace Model {
	...
	Q_OBJECT
		...
		Q_PROPERTY(Cadabra::Queen::Mentalgami::Meta::RiddleInformation::Specifications specifications READ getSpecifications NOTIFY specificationsChanged)

		Q_PROPERTY(QVector<QUrl> mediaList READ getMediaList WRITE setMediaList NOTIFY mediaListChanged)

		Q_PROPERTY(Cadabra::Queen::Mentalgami::Model::RiddleValidator* validator READ getValidator CONSTANT)
