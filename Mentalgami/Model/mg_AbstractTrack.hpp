...
#include "Application/mg_SmartCourse.hpp"
...
namespace Cadabra { namespace Queen { namespace Mentalgami { namespace Model {
	...
	Q_OBJECT
		...
		Q_PROPERTY(Cadabra::Queen::Mentalgami::Meta::Track::Scheme scheme READ getScheme NOTIFY imported)
