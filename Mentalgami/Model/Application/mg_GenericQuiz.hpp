#ifndef Cadabra_Queen_Mentalgami_Model_Application_GenericQuiz_hpp
#define Cadabra_Queen_Mentalgami_Model_Application_GenericQuiz_hpp

#include "../../../Repository/Model/AbstractApplication.hpp"

#include "Interface/mg_QuizInterface.hpp"
#include "../../Data/mg_RiddleList.hpp"

namespace Cadabra { namespace Queen { namespace Mentalgami { namespace Model {
	class GenericQuiz : public Repository::Model::AbstractApplication, Cadabra::Queen::Mentalgami::Model::QuizInterface
	{
	/** @name Qroperties */
	/** @{ */
	Q_OBJECT
		Q_INTERFACES(Cadabra::Queen::Mentalgami::Model::QuizInterface)
	...
	public:
		...
		Q_INVOKABLE void answer(Cadabra::Queen::Mentalgami::Model::AbstractRiddle* riddle);
	/** @} */
