...
PetrI {
	id: petrI
	objectName: "Регистрация Eureka-пациентов"
	...
	preActions: [
		Action {
			...
			onActed: {
				...
				console.log("currentToken.account =", petrI.context.patient.account);
				console.log("currentToken.code =", petrI.context.patient.code);
				console.log("currentToken.avatar.realm.objectName =", petrI.context.patient.realm.objectName);
			}
		}
	]
...
/*
	Port {
		source: "qrc:/Mentalgami/Test/Integration/SuperviserAuthorization.qml"
	}
*/
}
