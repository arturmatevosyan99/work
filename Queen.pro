...
#	SUBDIRS += Fantasia.pro # Reserved
	SUBDIRS += Eureka.pro # Smartphone CAP Frontend (SmartCare Edition)
	SUBDIRS += Afrodita.pro # Smartphone CAP Frontend (DrOblozhko Legacy Edition)
#	SUBDIRS += Angelina.pro # Smartphone CAP Frontend (MetabolicPlate/DrOblozhko Edition)
...
if (win32 | unix) {
	...
	SUBDIRS += Vanilla.pro # Desktop CAP Frontend (General Edition, GUI, CLI)
}
