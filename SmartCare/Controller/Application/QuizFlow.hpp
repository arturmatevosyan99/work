#ifndef Cadabra_Queen_SmartCare_Controller_QuizFlow_hpp
#define Cadabra_Queen_SmartCare_Controller_QuizFlow_hpp
...
namespace Cadabra { namespace Queen { namespace SmartCare { namespace Controller {
	...
	Q_OBJECT
		...
		Q_PROPERTY(Cadabra::Queen::SmartCare::View::RiddleView* active READ getActive NOTIFY activeChanged)
	/** @} */
	...
	signals:
		...
		void stacked(Cadabra::Queen::SmartCare::View::RiddleView* view, int index);
	/** @} */
...
QML_DECLARE_TYPE(Cadabra::Queen::SmartCare::Controller::QuizFlowAttachment)

/// @note Declares attached properties
QML_DECLARE_TYPEINFO(Cadabra::Queen::SmartCare::Controller::QuizFlow, QML_HAS_ATTACHED_PROPERTIES)
