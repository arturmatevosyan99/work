...
namespace Cadabra { namespace Queen { namespace SmartCare { namespace View {
	...
	Cadabra::Queen::SmartCare::View::TrackLayout* TrackView::getLayout() const
	{
		return _layout;
	}

	Cadabra::Queen::SmartCare::Model::AbstractTrack* TrackView::getModel() const
	{
		return _model;
	}
	...
	void TrackView::setLayout(Cadabra::Queen::SmartCare::View::TrackLayout* layout)
	{
		if (_layout == layout) {
			return;
		}
	...
	void TrackView::setModel(Cadabra::Queen::SmartCare::Model::AbstractTrack* model)
	{
		if (_model == model) {
			return;
		}
