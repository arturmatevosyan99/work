#ifndef Cadabra_Queen_SmartCare_View_RiddleView_hpp
#define Cadabra_Queen_SmartCare_View_RiddleView_hpp
...
namespace Cadabra { namespace Queen { namespace SmartCare { namespace View {
	...
	Q_OBJECT
		...
		Q_PROPERTY(Cadabra::Queen::SmartCare::Meta::RiddleInformation::Specifications specifications READ getSpecifications WRITE setSpecifications NOTIFY specificationsChanged)
		Q_PROPERTY(QVector<QUrl> mediaList READ getMediaList WRITE setMediaList NOTIFY mediaListChanged)
		Q_PROPERTY(Cadabra::Queen::SmartCare::Model::AbstractRiddle* model READ getModel WRITE setModel NOTIFY modelChanged)
