SMARTCARE_RESOURCES = $$PWD/SmartCare.qrc
...
SMARTCARE_HEADERS = \
	...
	$$PWD/Model/Application/SmartCourse.hpp \
	$$PWD/Model/Application/SmartBook.hpp \
	$$PWD/Model/Message/AwardMessage.hpp \
	$$PWD/Model/Message/SmartCourseMessage.hpp \
	$$PWD/Model/MarkdownDocument.hpp \
	$$PWD/Model/BookIndex.hpp \
...
SMARTCARE_SOURCES = \
	...
	$$PWD/Model/Application/SmartBook.cpp \
	$$PWD/Model/Message/AwardMessage.cpp \
	$$PWD/Model/Message/SmartCourseMessage.cpp \
	$$PWD/Model/MarkdownDocument.cpp \
	$$PWD/Model/BookIndex.cpp \
...
contains(QT, testlib) {
	SMARTCARE_RESOURCES += $$PWD/Test/SmartCareTest.qrc

	SMARTCARE_HEADERS += $$files($$PWD/Test/*.hpp, true)
	SMARTCARE_SOURCES += $$files($$PWD/Test/*.cpp, true)

	SMARTCARE_HEADERS += $$files($$PWD/Shocker/*.hpp, true)
	SMARTCARE_SOURCES += $$files($$PWD/Shocker/*.cpp, true)
}
