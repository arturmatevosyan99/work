...
namespace Cadabra { namespace Queen { namespace SmartCare { namespace Model {
	...
	bool AbstractTrack::import(SmartCourse* course_application, const Cadabra::Queen::SmartCare::Meta::Track& track_meta)
	{
		return import(
						course_application,
	...
	Meta::Track::SchemeIdent AbstractTrack::getSchemeIdent() const
	{
		...
		return QMetaType::UnknownType == type_id ? 0 : Core::Meta::Scheme<SmartCare::Meta::TrackRender>::Ident(QMetaType(type_id));
	}
