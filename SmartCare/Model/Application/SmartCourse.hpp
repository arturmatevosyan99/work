#ifndef Cadabra_Queen_SmartCare_Model_Application_SmartCourse_hpp
#define Cadabra_Queen_SmartCare_Model_Application_SmartCourse_hpp
...
#include "../../Data/Entity/CourseBrief.hpp"
#include "../../Data/Entity/CourseTrack.hpp"
...
namespace Cadabra { namespace Queen { namespace SmartCare { namespace Model {
	...
	Q_OBJECT
		 ...
		 * @brief ?
		 */
		Q_PROPERTY(Cadabra::Queen::SmartCare::Model::SmartCourse::IndexState indexState READ getIndexState NOTIFY indexed)
		/**
		 * @brief ?
		 */
		Q_PROPERTY(Cadabra::Queen::SmartCare::Model::SmartCourse::ProgressState progressState READ getProgressState NOTIFY progressed)
		/**
		 * @brief ?
		 */
...
Q_DECLARE_OPERATORS_FOR_FLAGS(Cadabra::Queen::SmartCare::Model::SmartCourse::IndexState)
Q_DECLARE_METATYPE(Cadabra::Queen::SmartCare::Model::SmartCourse::IndexState)
Q_DECLARE_OPERATORS_FOR_FLAGS(Cadabra::Queen::SmartCare::Model::SmartCourse::ProgressState)
Q_DECLARE_METATYPE(Cadabra::Queen::SmartCare::Model::SmartCourse::ProgressState)
