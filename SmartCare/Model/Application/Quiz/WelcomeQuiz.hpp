#ifndef Cadabra_Queen_SmartCare_Model_Application_Quiz_WelcomeQuiz_hpp
#define Cadabra_Queen_SmartCare_Model_Application_Quiz_WelcomeQuiz_hpp

#include "../GenericQuiz.hpp"

#include "../../../Net/Call/WelcomeCall.hpp"
...
namespace Cadabra { namespace Queen { namespace SmartCare { namespace Model {
	...
	Q_OBJECT
		...
		Q_PROPERTY(Cadabra::Queen::SmartCare::Model::WelcomeQuiz::Phase phase READ getPhase WRITE setPhase NOTIFY phaseChanged)
