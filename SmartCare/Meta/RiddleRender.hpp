#ifndef Cadabra_Queen_SmartCare_Meta_RiddleRender_hpp
#define Cadabra_Queen_SmartCare_Meta_RiddleRender_hpp
...
Q_DECLARE_METATYPE(Cadabra::Queen::SmartCare::Meta::RiddleRender)
