...
#ifndef Cadabra_Queen_SmartCare_Meta_TrackRender_hpp
#define Cadabra_Queen_SmartCare_Meta_TrackRender_hpp
...
namespace Cadabra { namespace Queen { namespace SmartCare { namespace Meta {
	...
	public:
		...
		Q_INVOKABLE QUrl makeURL(Cadabra::Queen::SmartCare::TrackRenderLayout layout) const;
	/** @} */
...
Q_DECLARE_METATYPE(Cadabra::Queen::SmartCare::Meta::TrackRender)
